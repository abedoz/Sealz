...
import com.junkfood.seal.download.PostDownloadHandler
        ...
        startKoin {
            ...
            modules(
                module {
                    ...
                    single { CloudStorageManager(androidContext()) }
                    single { AIManager(androidContext()) }
                    single { PostDownloadHandler(androidContext(), get(), get()) }
